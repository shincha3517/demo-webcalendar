...
@push('css-stack')
    ...
    <link rel="stylesheet" href="{{ Module::asset('schedule:css/lib/select2.min.css') }}">
...
<script src="{{ Module::asset('schedule:js/lib/moment.js') }}"></script>
<script src="{{ Module::asset('schedule:js/bootstrap-datepicker.min.js') }}"></script>
<script src="{{ Module::asset('schedule:js/lib/select2.min.js') }}"></script>

{{--<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>--}}
<script src="{{ Module::asset('schedule:js/lib/popper.min.js') }}"></script>
<script src="{{ Module::asset('schedule:js/lib/loadingoverlay.min.js') }}"></script>
