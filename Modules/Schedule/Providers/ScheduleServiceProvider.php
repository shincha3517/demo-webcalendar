...
// add bindings
        ...
        $this->app->bind(
            'Modules\Schedule\Repositories\AssignmentRepository',
            function () {
                $repository = new \Modules\Schedule\Repositories\Eloquent\EloquentAssignmentRepository(new \Modules\Schedule\Entities\Assignment());
