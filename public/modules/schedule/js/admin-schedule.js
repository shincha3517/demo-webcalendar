...
var Home = {
        ...
        $.ajax({
            ...
            success: function(result)
            {
                if(result.status==1){
                    ...
                    // var data = {
                    //     "time_slot": [{ "slot": "1", "start": "08:00", "end": "08:30" }, { "slot": "2", "start": "08:30", "end": "09:00" }, { "slot": "3", "start": "09:00", "end": "09:30" }, { "slot": "4", "start": "09:30", "end": "10:00" }, { "slot": "5", "start": "10:00", "end": "10:30" }, { "slot": "6", "start": "07:30", "end": "08:00" }, { "slot": "7", "start": "08:00", "end": "08:30" }, { "slot": "8", "start": "08:30", "end": "09:00" }, { "slot": "9", "start": "09:00", "end": "09:30" }, { "slot": "10", "start": "09:30", "end": "10:00" }, { "slot": "11", "start": "10:00", "end": "10:30" }, { "slot": "12", "start": "10:00", "end": "10:30" }, { "slot": "13", "start": "10:00", "end": "10:30" }, { "slot": "14", "start": "10:00", "end": "10:30" }, { "slot": "15", "start": "10:00", "end": "10:30" }, { "slot": "16", "start": "10:00", "end": "10:30" }, { "slot": "17", "start": "10:00", "end": "10:30" }],
                    //     "time_data": [{
                    //         "required": {
                    //             "teacher": "Ms Germain Kang",
                    //             "classes": [
                    //
                    //                 { "class": ["2E4", "3E3"], "lesson": "SC", "slot": [1], "start": "08:00", "end": "09:00", "flag": "paired" },
                    //                 { "class": ["2E4", "3E3"], "lesson": "SC", "slot": [2], "start": "08:00", "end": "09:00", "flag": "substituted" },
                    //                 { "class": ["2E4", "3E3"], "lesson": "SC", "slot": [5], "start": "08:00", "end": "09:00", "flag": "red" },
                    //                 { "class": ["2E4", "3E3"], "lesson": "SC", "slot": [6], "start": "08:00", "end": "09:00", "flag": "classes" },
                    //             ],
                    //         }
                    //     }],
                    // };
    ...
    searchAvailableTeacher: function(){
        ...
        $(".container-step3").on("click", "td.show-step4",function(event) {
            ...
            Home._ajaxSearchAvailableTeacher($this,selectedDate,optionAssigned);
    ...
    sortingOnChange: function(){
        $('body').on('change','#sorting', function(){
           var sortingOption = $(this).val();
           var itemClicked = Home.currentSlotClicked;

            if(itemClicked.hasClass('confirm') || itemClicked.hasClass('red')){
                return false;
            }
            var optionAssigned = false;
            if(itemClicked.hasClass('red')){
                var optionAssigned = true;
            }
            var selection = itemClicked.data('scheduleid');
            var selectedDate = $('#my_hidden_input').val();

            Home._ajaxSearchAvailableTeacher(itemClicked,selectedDate,optionAssigned,sortingOption);
    ...
    _ajaxSearchAvailableTeacher: function(itemClicked, selectedDate,optionAssigned, sortingOption) {
        var $this = itemClicked;
        if(sortingOption == false){
            sortingOption = 1;// default sorting by subject.
        }
        $.ajax({
            url : "/backend/schedule/getAvailableUserByEvents",
            type: "GET",
            data: {eventIds: Home.schedule_ids,date:selectedDate,optionAssigned: optionAssigned, sorting: sortingOption},
            beforeSend: function( xhr ) {
                // Show full page LoadingOverlay
                $.LoadingOverlay("show");
            },
